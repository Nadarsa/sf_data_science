...
#plt.savefig('/Users/nadezdaoskina/Документы/SkillFactory/sf_data_science/my_first_container/src/output/10plot.png')
#plt.savefig('./src/output/plot.png')
plt.savefig('/usr/src/app/output/plot2.png')
